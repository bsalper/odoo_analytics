...
def extraer_sku_y_nombre(product_str):
    """
    Separa el formato estándar de productos de Odoo '[SKU] Nombre' en dos componentes.
    Ejemplo: "[PROD001] Aceite de Oliva" -> Devuelve ("PROD001", "Aceite de Oliva")
    """
    if not product_str:
        return "", ""
