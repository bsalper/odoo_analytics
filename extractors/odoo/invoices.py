...
def get_invoices_raw(client, fecha_inicio="2023-01-01"):
    ...
    domain = [
        ("move_type", "in", ["out_invoice", "out_refund", "out_charge"]), ## out_invoice: facturas y boletas electronicas / out_refund: nota de credito / out_charge: notas y boletas de debito
...
def get_invoice_lines_raw(client, fecha_inicio="2023-01-01", fecha_fin=None):
    ...
    domain = [
        ("move_id.move_type", "in", ["out_invoice", "out_refund", "out_charge"]),
